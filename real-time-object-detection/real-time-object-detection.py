...
#   USAGE
# ------------------------
# python real-time-object-detection.py --prototxt MobileNetSSD/MobileNetSSD_deploy.prototxt.txt
...
while True:
    ...
    for i in np.arange(0, detections.shape[2]):
        ...
        if confidence > args["confidence"]:
            # extract the index of the class label from the 'detections', then compute the (x, y)-coordinates of the
            # bouding box for the object
